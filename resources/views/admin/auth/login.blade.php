        ...
        <form class="form" id="login-form" action="{{ route('login') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control form-control-solid h-auto py-5 px-6 rounded-lg border-0" type="text"
                    name="{{ config('fortify.username') }}" id="{{ config('fortify.username') }}" autocomplete="off" />
            </div>
            <!--end::Form group-->
            ...
            <div class="pb-lg-0 pb-5">
                ...
                {{-- <button type="button" class="btn btn-light-primary font-weight-bolder px-8 py-4 my-3 font-size-lg">
                    <span
                        class="svg-icon svg-icon-md"><!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/social-icons/google.svg--><svg
