...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item text-muted">
        <a href="{{ route('users.index') }}" class="text-muted mr-2">Users</a>
    </li>
@endsection
@section('content')
    <div class="col-12">
        ...
        <div class="card card-custom">
            ...
            <div class="card-body">
                ...
                <!--begin Modal-->
                @include('admin.users.modals.user_modal')
                @include('admin.users.modals.role_modal')
