    ...
    <div class="dropdown dropdown-inline"> <a href="javascript:;" class="btn btn-sm btn-clean btn-icon mr-2 mt-4"
        ...
        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right" style="display: none;">
            <ul class="nav nav-hoverable flex-column updated-menu">
                ...
                <li class="nav-item">
                    <a href="{{ route('users.show', $row->id) }}" class="nav-link btn btn-sm btn-clean btn-icon userViewBtn"
                ...
                <li class="nav-item">
                    <a href="javascript:void(0);" class=" nav-link btn btn-sm btn-clean btn-icon userEditBtn"
                        data-id="{{ $row->id }}" data-url="{{ route('users.edit', $row->id) }}" 
                ...
                <li class="nav-item"> 
                    <a href="javascript:void(0);" class=" nav-link btn btn-sm btn-clean btn-icon userDelBtn"
                        data-url="{{ route('users.destroy', $row->id) }}"  data-placement="bottom"
                ...
                <li class="nav-item">
                    <a href="javascript:void(0);" class="nav-link btn btn-sm btn-clean btn-icon userRoleBtn" 
                    
                        data-url="{{ route('roles.user', $row->id) }}"
                        data-placement="bottom" title="Add Role">
                ...
                <li class="nav-item">
                    <a href="{{ route('user.permissions.index', $row->id) }}" class=" nav-link btn btn-sm btn-clean btn-icon "
                     
                        data-placement="bottom" title="User Permissions">
                        <i class="fa fa-cog"></i>
